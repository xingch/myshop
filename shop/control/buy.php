        ...
        $model_addr = Model('address');
     	if (chksubmit()){
     		...
     		$obj_validate->validateparam = array(
				...
				array("input"=>$_POST["post_code"],"require"=>"true","validator"=>"postcode","message"=>"请输入正确的邮政编码"),
			...
			if(!$obj_validate->isIDcard($_POST["id_number"])){
				exit(json_encode(array('state'=>false,'msg'=>'身份证号码不正确')));
			}
			$data = array();
