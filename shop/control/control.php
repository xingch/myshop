...
class BaseSellerControl extends Control {
    ...
    private function _getMenuList() {
        $menu_list = array(
            ...
            */
        	'wifi' => array('name' => 'WIFI管理', 'child' => array(
        		array('name' => '路由管理', 'act'=>'wifi_gw', 'op'=>'index'),
        		array('name' => '认证模板', 'act'=>'wifi_auth', 'op'=>'index'),
        		array('name' => '在线用户', 'act'=>'wifi_user', 'op'=>'online'),
        		array('name' => '历史用户', 'act'=>'wifi_user', 'op'=>'offline'),
        	)),
