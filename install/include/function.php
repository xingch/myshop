...
function check_db($db_host, $db_user, $db_pwd, $db_name, $db_prefix, $db_port) {
	if(!function_exists('mysqli_connect')) {
		show_msg('undefined function : mysqli_connect()');
	}
	if(!@mysqli_connect($db_host.":".$db_port, $db_user, $db_pwd)) {
		show_msg('database connect failed');
	} else {
		if($query = mysqli_query("SHOW TABLES FROM $db_name")) {
