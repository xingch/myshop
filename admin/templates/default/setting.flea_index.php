...
<div class="page">
  ...
  <form method="post" enctype="multipart/form-data" name="form1">
    ...
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><label for="flea_isuse">闲置开关<?php echo $lang['nc_colon'];?></label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform onoff">
          	<label for="isuse_1" class="cb-enable <?php if($output['setting']['flea_isuse'] == 1){ ?>selected<?php } ?>" title="<?php echo $lang['nc_open'];?>"><span><?php echo $lang['nc_open'];?></span></label>
            <label for="isuse_0" class="cb-disable <?php if($output['setting']['flea_isuse'] == 0){ ?>selected<?php } ?>" title="<?php echo $lang['nc_close'];?>"><span><?php echo $lang['nc_close'];?></span></label>
            <input type="radio" id="isuse_1" name="flea_isuse" value="1" <?php echo $output['setting']['flea_isuse']==1?'checked=checked':''; ?>>
            <input type="radio" id="isuse_0" name="flea_isuse" value="0" <?php echo $output['setting']['flea_isuse']==0?'checked=checked':''; ?>></td>
          <td class="vatop tips">关闭后闲置前台将无法访问</td>
        </tr>
        <tr>
