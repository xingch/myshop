  ...
  <div class="ncs-detail<?php if ($output['store_info']['is_own_shop']) echo ' ownshop'; ?>">
    ...
    <div class="ncs-goods-summary">
      ...
      <div class="ncs-meta">
        ...
        <!-- S 商品参考价格 -->
        <dl>
          <dt><?php /**echo $lang['goods_index_goods_cost_price'];**/echo "市场零售价"?><?php echo $lang['nc_colon'];?></dt>
          <dd class="cost-price"><strong><?php echo $lang['currency'].$output['goods']['goods_marketprice'];?></strong></dd>
        </dl>
        <dl>
        <dt><?php /**echo $lang['goods_index_goods_cost_price'];**/echo "商城零售价"?><?php echo $lang['nc_colon'];?></dt>
            <dd class="price">
            <?php if (isset($output['goods']['title']) && $output['goods']['title'] != '') {?>
            <span class="tag"><?php echo $output['goods']['title'];?></span>
			 <?php }?>
            <strong><?php echo $lang['currency'].$output['goods']['goods_price'];?></strong><em>立 刻 省<?php echo $lang['nc_colon'];?></em> <strong><?php echo $lang['currency'];echo ( floatval($output['goods']['goods_marketprice'])-floatval($output['goods']['goods_price']));?></strong></em>
			</dd>
        </dl>		
        <!-- E 商品参考价格 -->
        <!-- S 商品发布价格 -->
        <dl>
          <dt><?php /**echo $lang['goods_index_goods_cost_price'];**/echo "商城批发价"?><?php echo $lang['nc_colon'];?></dt>
		  <?php if (isset($output['goods']['promotion_type']) && $output['goods']['promotion_type'] == 'xianshi') {?>
          <dd class="price">
            <?php if (isset($output['goods']['promotion_price']) && !empty($output['goods']['promotion_price'])) {?>
            <strong><?php echo $lang['currency'];echo $output['goods']['promotion_price']?></strong><em style="color:green"><?php echo sprintf('最低%s件起 ',$output['goods']['lower_limit']);?></em><em><?php echo $output['goods']['explain'];?></em><em><?php echo '比商城零售直降：</em><strong style="color:red">'.$lang['currency'].$output['goods']['down_price'].'</strong>';?>
            <?php } else {?>
            <strong><?php echo $lang['currency'];echo $output['goods']['goods_price']?></strong>
            <?php }?>
          </dd>			
		  <?php } else {?>
          <dd class="cost-price"><strong>商品暂不支持</strong></dd>
		  <?php }?>
        </dl>		
        <!-- E 商品发布价格 -->
        <!-- S 促销 -->
        <?php if ((isset($output['goods']['promotion_type']) && $output['goods']['promotion_type'] !== 'xianshi') || $output['goods']['have_gift'] == 'gift') {?>
        <dl>
          <dt>促销信息：</dt>
    ...
    <div class="ncs-goods-main" id="main-nav-holder">
      ...
      <div class="ncg-salelog">
        ...
        <div class="ncs-goods-info-content bd" id="ncGoodsTraded">
          <div class="top">
            <div class="price">商城零售价<strong><?php echo $output['goods']['goods_price'];?></strong><?php echo $lang['goods_index_yuan'];?><span>购买的价格不同可能是由于商家往期促销活动引起的，详情可以咨询商家</span></div>
          </div>
          <!-- 成交记录内容部分 -->
