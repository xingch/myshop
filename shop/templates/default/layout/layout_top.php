...
<div class="public-top-layout w">
  <div class="topbar wrapper">
    ...
    <div class="quick-menu">
	  ...
	  <dl>
        <dt><a href="#" title="招商入驻">招商入驻</a><i></i></dt>
        <dd>
          <ul>
		    <li><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=show_joinin&op=index" title="成为商家">成为商家</a></li>
            <li><a href="<?php echo urlShop('seller_login','show_login');?>" target="_blank" title="成为供货商">成为供应商</a></li>
			<li><a href="<?php echo urlShop('seller_login','show_login');?>" target="_blank" title="我要分销">我要分销</a></li>
          </ul>
        </dd>
      </dl>
      <dl>
